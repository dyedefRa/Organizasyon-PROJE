...
{
    [DbContext(typeof(OrganizasyonDbContext))]
    [Migration("20230118214754_Add-Entities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Organizasyon.Entities.Cities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Organizasyon.Entities.Companies.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("CompanyValidDate")
            ...
            modelBuilder.Entity("Organizasyon.Entities.CompanyOrganizationConcepts.CompanyOrganizationConcept", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AppCompanyOrganizationConcepts");
                });

            modelBuilder.Entity("Organizasyon.Entities.CompanyPackages.CompanyPackage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("CompanyAfterValidDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("CompanyBeforeValidDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("PackageDateAmount")
                        .HasColumnType("int");

                    b.Property<int>("PackageDateUnitType")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppCompanyPackages");
                });

            modelBuilder.Entity("Organizasyon.Entities.Concepts.Concept", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AppConcepts");
                });

            modelBuilder.Entity("Organizasyon.Entities.Files.File", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Organizasyon.Entities.FrequentlyAskedQuestions.FrequentlyAskedQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("FrequentlyAskedQuestionType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Organizasyon.Entities.Labels.Label", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Organizasyon.Entities.Logs.Log", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Organizasyon.Entities.MailTemplates.MailTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Organizasyon.Entities.Organizations.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Organizasyon.Entities.Packages.Package", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("DateAmount")
                        .HasColumnType("int");

                    b.Property<int>("DateUnitType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Organizasyon.Entities.SentMails.SentMail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Organizasyon.Entities.Towns.Town", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Organizasyon.Users.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Organizasyon.Entities.Companies.Company", b =>
                {
                    b.HasOne("Organizasyon.Users.AppUser", "User")
                        .WithOne("Company")
                        .HasForeignKey("Organizasyon.Entities.Companies.Company", "UserId")
            ...
            modelBuilder.Entity("Organizasyon.Entities.CompanyOrganizationConcepts.CompanyOrganizationConcept", b =>
                {
                    b.HasOne("Organizasyon.Entities.Companies.Company", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Organizasyon.Entities.Concepts.Concept", "Concept")
                        .WithMany()
                        .HasForeignKey("ConceptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Organizasyon.Entities.Organizations.Organization", "Organization")
                        .WithMany()
            ...
            modelBuilder.Entity("Organizasyon.Entities.CompanyPackages.CompanyPackage", b =>
                {
                    ...
                    b.HasOne("Organizasyon.Entities.Packages.Package", "Package")
                        .WithMany("CompanyPackages")
            ...
            modelBuilder.Entity("Organizasyon.Entities.Files.File", b =>
                {
                    ...
                    b.HasOne("Organizasyon.Entities.Organizations.Organization", "Organization")
                        .WithOne("Image")
                        .HasForeignKey("Organizasyon.Entities.Files.File", "OrganizationId");
            ...
            modelBuilder.Entity("Organizasyon.Entities.Towns.Town", b =>
                {
                    b.HasOne("Organizasyon.Entities.Cities.City", "City")
                        .WithMany("Towns")
            ...
            modelBuilder.Entity("Organizasyon.Users.AppUser", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("Organizasyon.Users.AppUser", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
